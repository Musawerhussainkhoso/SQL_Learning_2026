/*
in AND op both conditions must be true 
*/
...
-- . Find Current account holders with balance above 100,000
SELECT full_name , account_type , balance 
FROM customers 
WHERE account_type = "Current" AND balance > 100,000;

-- Find customers in Lahore or Multan with balance less than 50,000 (three conditions using AND)
SELECT full_name, city, balance
FROM customers
WHERE (city = 'Lahore' OR city = 'Multan') AND balance < 50000;