...
-- 1. Show unique city and account type combinations
SELECT DISTINCT city, account_type
FROM customers;

-- 2. Show unique cities where customers have Savings account
SELECT DISTINCT city
FROM customers
WHERE account_type = 'Savings';

-- 3. Show unique account types for customers with balance greater than 100000
